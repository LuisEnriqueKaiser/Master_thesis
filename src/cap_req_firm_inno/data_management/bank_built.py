...
def create_pivot(data, value):
    ...
    data_pivot.columns = ["gvkey"] + [
        str(value) + "_" + str(year) for year in data_pivot.columns[1:]
    ]
    return data_pivot
...
banks_data_pivot = process_dataframe(
    df=banks_data_pivot,
    columns=["capr1_2007", "capr1_2008", "capr1_2009"],
    threshold=10,
)

banks_data_pivot.to_csv(
