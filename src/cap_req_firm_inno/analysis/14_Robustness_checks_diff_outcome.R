...
# create the different outcome variables, using sales as a denominator
#####################################################################################
...
# regression
did_reg_lead2_rd_sale = plm(lead2_r_d_intensity_sale ~   did +
                              factor(year) + factor(gvkey),
                            model = "within",
                            index = c("gvkey", "year"),
                            data = subset_reg2)
